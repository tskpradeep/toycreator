...
padding:10px; width:100%; outline:none; font-family:monospace; box-sizing:border-box;
}
...
function saveToJSON() {
    ...
    alert("Configuration Saved to comutoy.json");
}
</script>
"""

res = components.html(aisettoy_html, height=700)
if res:
