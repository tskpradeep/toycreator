...
st.set_page_config(layout="wide", page_title="AI-SET Configuration")

# The EXACT HTML portion from your original code, isolated
aisettoy_html = """
<style>
html, body {
...
background:#000; border:2px solid #00ff00; box-sizing:border-box;
}
.ai-setup-header{
background:#0a1a0a; border-bottom:1px solid #00ff00;
padding:10px; display:flex; justify-content:space-between;
color:#00ff00; font-weight:bold; align-items:center;
}
...
padding:10px; width:100%; outline:none; font-family:monospace;
}
.title-action-btn{
...
<div id="ai-modular-setup">
    <div class="ai-setup-header">
        ...
        <div class="ai-header-controls">
            ...
            <button class="title-action-btn" onclick="window.history.back()">[ X ]</button>
        </div>
    </div>
...
function saveData() {
    const data = {
        model: document.getElementById('version-select').value,
...
# Receive the data from the component and write it to comutoy.json
result = components.html(aisettoy_html, height=800)
