...
<style>
    ...
    .ai-text-area { width: 100%; height: 100%; padding: 10px; color: #00ff00; font-family: monospace; font-size: 13px; overflow-y: auto; white-space: pre-wrap; }
...
<div class="master-container">
    <div id="ai-modular-setup">
        ...
        <div class="ai-setup-body">
            <div class="ai-setup-sidebar"><div style="color:#00ff00; padding:10px;">GOOGLE GEMINI</div></div>
    ...
    <div id="dynamic-zone">
        ...
        <div id="right-stack" style="display:flex; flex-direction:column; width:30%;">
            ...
            <div id="ai-input" class="pane" style="flex:1;"><textarea id="user-prompt" class="user-input-area" placeholder="TYPE COMMAND..."></textarea></div>
        </div>
...
<script>
    ...
    async function callGemini(promptText) {
        ...
        if (!apiKey) { chatWindow.innerHTML += "<br>[ERR]: NO KEY"; return; }
