...
<style>
html,body{{margin:0;padding:0;height:100%;width:100%;overflow:hidden;background:#000;color:#fff;font-family:'Segoe UI',Tahoma,sans-serif;}}
.master-container{{display:flex;flex-direction:column;height:100vh;width:100vw;background:#000;border:2px solid #d3d3d3;position:relative;box-sizing:border-box;}}
#ai-modular-setup{{position:absolute;top:10%;left:15%;width:70%;height:75%;display:none;z-index:9999;}}
...
.btn-cell{{width:20px;height:20px;background:#e1e1e1;border-top:2px solid #fff;border-left:2px solid #fff;border-right:2px solid #707070;border-bottom:2px solid #707070;}}
.pane{{background:#000;border:1px solid #333;display:flex;overflow:hidden;align-items:center;justify-content:center;}}
...
.dropup{{width:100%;height:20px;background:#e1e1e1;color:#000;border:1px solid #707070;display:flex;align-items:center;justify-content:space-between;padding:0 5px;font-size:9px;}}
.dropup.tall{{height:62px;}}
.text-main{{color:#b22222;font-size:1.4vw;font-weight:bold;width:100%;height:100%;display:flex;align-items:center;justify-content:center;}}
.ai-text-area{{width:100%;height:100%;padding:10px;color:#00ff00;font-family:Consolas,monospace;font-size:13px;overflow-y:auto;}}
.user-input-area{{width:100%;height:100%;background:transparent;border:none;color:#800080;padding:10px;font-family:Consolas,monospace;resize:none;outline:none;font-weight:bold;}}
.cmd-text{{width:100%;height:100%;color:#0f0;font-family:monospace;font-size:11px;padding:5px;white-space:pre-wrap;overflow-y:auto;}}
</style>
...
<div style="color:#444;font-size:12px;font-family:monospace;">[ IDLE: AWAITING CIRCUIT REQUEST ]</div>
</div>
