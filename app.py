    ...
    async function callGemini(promptText) {
        ...
        try {
            ...
            if (response.ok && data.candidates && data.candidates[0].content) {
                ...
                const errMsg = data.error ? data.error.message : "INVALID RESPONSE STRUCTURE";
                chatWindow.innerHTML += `<br><br><span style='color:red'>[API ERROR]: ${errMsg}</span>`;
                terminal.innerHTML += "\\n> API_RESPONSE: FAILED";
            }
